...
**Plans:** 4 plans
Plans:
- [ ] 06-01-PLAN.md — i18n content for all 7+1 career stations, 6 projects, 10 certs, 3 education entries (DE+EN)
- [ ] 06-02-PLAN.md — Expandable career station cards with animated accordion + certifications section
- [ ] 06-03-PLAN.md — Projects section expansion to 6 cards with staggered scroll animations
- [ ] 06-04-PLAN.md — Visual verification checkpoint (mobile + desktop, DE + EN)
**UI hint**: yes
...
| 6. Content Expansion | 0/4 | Not started | - |
